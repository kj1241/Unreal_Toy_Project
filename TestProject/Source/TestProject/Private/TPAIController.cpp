...
ATPAIController::ATPAIController()
{
	...
	static ConstructorHelpers::FObjectFinder<UBlackboardData> 
		BBObject(TEXT("/Game/TestProject/AI/BB_TPCharacter.BB_TPCharacter"));
	...
	static ConstructorHelpers::FObjectFinder<UBehaviorTree> 
		BTObject(TEXT("/Game/TestProject/AI/BT_TPCharacter.BT_TPCharacter"));
...
void ATPAIController::OnPossess(APawn* InPawn)
{
	...
	//GetWorld()->GetTimerManager().SetTimer(RepeatTimerHandle, this, &ATPAIController::OnRepeatTimer, RepeatInterval, true);
...
void ATPAIController::OnUnPossess()
{
	Super::OnUnPossess();
...
//void ATPAIController::OnRepeatTimer()
//{
